...
`
def.textContent = "An airplane is an air vehicle heavier than air, equipped with fixed wings and one or more engines, capable of flying by using the lift generated by its wings."
;
})
...
//--------------i-------------
  ...
  `;
  def.textContent = "Le mot indigo régit à la fois le savoir, l'intelligence, la sagesse… mais aussi l'intuition, l'imagination et la clairvoyance.";
  ...
  //----------j----------------------
    ...
    `;
    def.textContent = "Le mot <jaune>  peut être utilisé pour parler d'un poussin, du soleil et de bien d'autres choses encore.";
